    ...
    return (
        <footer className="footer mt-12">
            ...
            <div className="bg-slate-100 dark:bg-zinc-800">
                <div className="px-10 py-7 lg:py-8 lg:px-[12%] flex gap-5 items-center justify-between sa-container">
                    ...
                    <div className="flex items-center justify-center gap-4  lg:gap-5">
                        <a href="#">
                            <img src={CONSTANTS.IMG_CDN + "portal/m/play_store.png"} alt="Download Android App" />
                        </a>
                        <a href="#">
                            <img src={CONSTANTS.IMG_CDN + "portal/m/app_store.png"} alt="Download iOS App" />
                        </a>
                    </div>
                </div>
            </div>
