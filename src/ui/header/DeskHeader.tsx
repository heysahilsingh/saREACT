    ...
    return (
        <div className="sa-container mx-auto flex gap-10 items-center p-4">
            ...
            <div className="location flex gap-2 items-center justify-start cursor-pointer text-sm">
                ...
                <svg className="fill-primary" xmlns="http://www.w3.org/2000/svg" width="22" height="32" viewBox="0 0 256 256">
                ...
                <ul className="flex items-center gap-12">
                    <li>
                        <Link to="/search" className="group flex items-center gap-2 hover:text-primary">
                            <svg className="fill-zinc-600 dark:fill-slate-300 group-hover:fill-primary" viewBox="5 -1 12 25" height="17" width="17">
                    ...
                    <li>
                        <Link to="/offers" className="group flex items-center gap-2 hover:text-primary">
                            <svg className="fill-zinc-600 dark:fill-slate-300 group-hover:fill-primary" viewBox="0 0 32 32" height="19" width="19">
                    ...
                    <li>
                        <Link to="/help" className="group flex items-center gap-2 hover:text-primary">
                            <svg className="fill-zinc-600 dark:fill-slate-300 group-hover:fill-primary" viewBox="6 -1 12 25" height="19" width="19">
                    ...
                    <li>
                        <Link to="/account" className="group flex items-center gap-2 hover:text-primary">
                            <svg className="fill-zinc-600 dark:fill-slate-300 group-hover:fill-primary" viewBox="6 0 12 24" height="19" width="18">
                    ...
                    <li>
                        <Link to="/cart" className="group flex items-center gap-2 hover:text-primary">
                            <div className="relative">
                                <svg className="fill-white stroke-black stroke-2 dark:fill-neutral-950 dark:stroke-slate-300 group-hover:stroke-primary group-hover:fill-none" viewBox="-1 0 37 32" height="20" width="20">
